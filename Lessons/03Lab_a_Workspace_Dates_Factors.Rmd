...
# ex
the_year = "1865"
str_juneteenth1 <- paste("June 19",the_year)
date_juneteenth1 <- mdy(str_juneteenth1)
date_juneteenth1
```
### The century issue
...
usgs_flow_data$month <- factor(usgs_flow_data$month, levels = 1:12,labels = month.abb)
