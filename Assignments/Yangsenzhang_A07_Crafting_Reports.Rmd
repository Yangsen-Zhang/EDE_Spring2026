...
```{r ozone_box_2018, echo=FALSE, fig.align='left', fig.height=2.3, fig.width=6.5, fig.cap='Monthly Ozone (2018).'}
epa_data %>%
  filter(Year == 2018) %>%
  mutate(
...
```{r ozone_box_2019, echo=FALSE, fig.align='left', fig.height=2.3, fig.width=6.5, fig.cap='Monthly Ozone (2019).'}
epa_data %>%
  filter(Year == 2019) %>%
  mutate(
    Month_f = factor(Month, levels = 1:12, labels = month.abb)
...
## Git Repository: 
https://github.com/Yangsen-Zhang/EDE_Spring2026/tree/main/Assignments
  
I did not use AI in the completion of this assignment - Yangsen Zhang 03/02/2026